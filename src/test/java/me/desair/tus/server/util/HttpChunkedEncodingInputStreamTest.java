...
public class HttpChunkedEncodingInputStreamTest {
    ...
    public void chunkedWithoutHeaders() throws IOException {
        String content = "4\r\n" + "Wiki\r\n" + "5\r\n" + "pedia\r\n" + "D\r\n" + " in\n" + "\n\r" + "chunks.\r\n" + "0\r\n" + "\r\n";
        HttpChunkedEncodingInputStream inputStream = new HttpChunkedEncodingInputStream(IOUtils.toInputStream(content, StandardCharsets.UTF_8));
    ...
    public void chunkedWithHeaders() throws IOException {
        ...
        HttpChunkedEncodingInputStream inputStream = new HttpChunkedEncodingInputStream(IOUtils.toInputStream(content, StandardCharsets.UTF_8), trailerHeaders);
    ...
    public void testChunkedInputStream() throws IOException {
        ...
        InputStream in = new HttpChunkedEncodingInputStream(IOUtils.toInputStream(correctInput, StandardCharsets.UTF_8), trailerHeaders);
        StringWriter writer = new StringWriter();
    ...
    @Test
    public void testCorruptChunkedInputStream1() {
        Assertions.assertThrows(IOException.class, () -> {
            //missing \r\n at the end of the first chunk
            String corruptInput = "10;key=\"val\\ue\"\r\n" + "1234567890" + "12345\r\n" + "5\r\n" + "12345\r\n" + "0\r\n" + "Footer1: abcde\r\n" + "Footer2: fghij\r\n";
            InputStream in = new HttpChunkedEncodingInputStream(IOUtils.toInputStream(corruptInput, StandardCharsets.UTF_8), trailerHeaders);
            StringWriter writer = new StringWriter();
            IOUtils.copy(in, writer, StandardCharsets.UTF_8);
        });
    }
    ...
    public void testEmptyChunkedInputStream() throws IOException {
        String input = "0\r\n";
        InputStream in = new HttpChunkedEncodingInputStream(IOUtils.toInputStream(input, StandardCharsets.UTF_8), trailerHeaders);
        StringWriter writer = new StringWriter();
        IOUtils.copy(in, writer, StandardCharsets.UTF_8);
