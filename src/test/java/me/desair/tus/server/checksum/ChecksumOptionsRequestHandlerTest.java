...
public class ChecksumOptionsRequestHandlerTest {
    ...
    public void processListExtensions() throws Exception {
        ...
        assertThat(Arrays.asList(servletResponse.getHeader(HttpHeader.TUS_EXTENSION).split(",")), containsInAnyOrder("checksum", "checksum-trailer"));
        assertThat(Arrays.asList(servletResponse.getHeader(HttpHeader.TUS_CHECKSUM_ALGORITHM).split(",")), containsInAnyOrder("md5", "sha1", "sha256", "sha384", "sha512"));
    }
